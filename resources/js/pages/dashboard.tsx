...
export default function Dashboard({ stocks_total,hopitaux_connectes,alertes_avertissement_expiration,transferts_en_attente,recentActivities }: { stocks_total: number,hopitaux_connectes: number,alertes_avertissement_expiration: number,transferts_en_attente: number,recentActivities: any }) {
    return (
