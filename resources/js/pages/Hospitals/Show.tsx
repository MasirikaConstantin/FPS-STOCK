...
import { App, Hopital, Hospital, PageProps } from '@/types/types';
import { Head, Link } from '@inertiajs/react';
import { MapPin, Phone, Mail, User, Building, Bed, Activity, Car } from 'lucide-react';
import HospitalStatsDashboard from './Stats';

export default function Show({ hopital, movements, productDistribution , alerts,transactionHistory,stockData}: PageProps<{ hopital: Hopital }>) {
