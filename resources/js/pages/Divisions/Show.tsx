    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <DeleteDialog
                ...
                route={route('divisions.destroy', division.id)}
                title="Supprimer la division"
                message={`Êtes-vous sûr de vouloir supprimer la division ${division.nom} ?`}
                successMessage="Division supprimée avec succès"
                errorMessage="Impossible de supprimer : cette division a des subdivisions"
            />
        </AppLayout>
    );
}